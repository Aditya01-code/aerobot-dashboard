...
# --- HELPER: IMAGE ENCODER (OPTIMIZED) ---
@st.cache_data  # Caches the image in memory to prevent slow reloading
...
def show_dashboard():
    ...
    with col_icon:
        # RESTORED: Custom SVG Icon (Electric Blue Line Chart)
        st.markdown("""
    ...
    # --- ROW 1: UPLOAD (Left) | COVER IMAGE (Right) ---
